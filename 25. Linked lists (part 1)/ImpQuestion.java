...
//amazon,adobe,flipkart,qualcomm
public class ImpQuestion {//linear time complexity
        ...
        public int helper(Node head, int key){//actual recursive fxn-O(n)
        ...
        public void reverse(){//O(n) 3 variables 4 operations
            Node prev =null;
            Node curr = tail = head ;//assignment from right to left
            Node next ;
            while(curr!=null){
                next=curr.next;
                curr.next= prev;
